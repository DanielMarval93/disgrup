              ...
              >
                <div className="container-xxl">
                  <h1 className="ptf-single-post__title ">
                    Denunciamos al Ayuntamiento de Barcelona
                  </h1>
                      ...
                      */}
                      <div className="row">
                        <div className="col-lg-6">
                          ...
                          <div className="col-lg-6">
                          <img src="assets/img/blog/grid/post-9.jpg" alt="imagen" style={{"paddingTop":"2.2rem"}} />
                      ...
                      ></div>
                          ...
                          <p>
                            Según el relevamiento realizado por nuestro equipo,
                            se necesitan 50 millones de Euros para realizar las
                            adaptaciones arquitectónicas necesarias en nuestra
                            ciudad. De esta manera, se podría cumplir con el
                            cupo de taxis adaptados que marca la ley, como así
                            también con los ascensores en las estaciones del
                            Metro y con las rampas de los autobuses (ya que
                            hemos identificado que, en algunos casos, las rampas
                            de las nuevas unidades que salen a la calle cumplen
                            menos su función que la de los autobuses que ya
                            tienen unos años).
                          </p>
